...
public class TextXmlWriter implements XmlWriter
{
     ...
     * Sets the doctype.
     * 
     * @see XmlWriter#setDoctype(String)
     */
     ...
     * Sets the doctype.
     *
     * @see XmlWriter#setDoctype(String, String)
     */
     ...
     * Sets the doctype.
     *
     * @see XmlWriter#setDoctype(String, String, String)
     */
     ...
     *
     * @see XmlWriter#addStartElement(String)
     */
     ...
     *  Adds a start element tag.
     *
     * @see XmlWriter#addStartElement(String, XmlAttribute[])
     */
     ...
     *
     * @see XmlWriter#addEmptyElement(String)
     */
     ...
     *
     * @see XmlWriter#addEmptyElement(String, XmlAttribute[])
     */
     ...
     *
     * @see XmlWriter#addCharacters(char[], int, int)
     */
     ...
     *
     * @see XmlWriter#addCharacters(String)
     */
